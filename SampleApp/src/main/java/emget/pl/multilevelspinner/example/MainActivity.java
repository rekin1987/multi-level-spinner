...
public class MainActivity extends AppCompatActivity {
     ...
     * @return Returns a list of {@link SpinnerItem} items representing the items multi level hierarchy.
     */
    private List<SpinnerItem> prepareList2() {
        List<SpinnerItem> list = new ArrayList<>();
        // top category
        SpinnerItemHeader chemicals = new SpinnerItemHeader("id1", "Chemicals");
        chemicals.addChild(new SpinnerItemElement("id1_1", "domestos"));
        ...
        still.addChild(new SpinnerItemElement("id2_1_1", "water"));
        still.addChild(new SpinnerItemElement("id2_1_2", "lemoniade"));
        // subcategories under 'drinks'
        SpinnerItemHeader sparkling = new SpinnerItemHeader("id2_2", "Sparkling");
        SpinnerItemHeader alco = new SpinnerItemHeader("Alcohol");
        SpinnerItemHeader nonAlco = new SpinnerItemHeader("Non-alcohol");
        SpinnerItemHeader soft = new SpinnerItemHeader("Soft");
        SpinnerItemHeader hard = new SpinnerItemHeader("Hard");

        nonAlco.addChild(new SpinnerItemElement("cola"));
        nonAlco.addChild(new SpinnerItemElement("fanta"));
        nonAlco.addChild(new SpinnerItemElement("sprite"));

        soft.addChild(new SpinnerItemElement("beer"));
        soft.addChild(new SpinnerItemElement("cider"));
        soft.addChild(new SpinnerItemElement("wine"));

        hard.addChild(new SpinnerItemElement("vodka"));
        hard.addChild(new SpinnerItemElement("whiskey"));

        alco.addChild(soft);
        alco.addChild(hard);

        sparkling.addChild(alco);
        sparkling.addChild(nonAlco);
